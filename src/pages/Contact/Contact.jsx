  ...
  emailjs
    ...
    return(
        ...
        <div className="contact-intro" >
            ...
            <p id="contact-header">Let's make something <span>Great!</span></p>
        ...
        <form className="contact-form" onSubmit={sendEmail}>
            ...
            <a title="Email" href="mailto:reimierreyes0221@gmail.com" target="_blank" rel="noreferrer" className="icons"><i class="fa-regular fa-envelope" id="email"></i></a>
            </div>
